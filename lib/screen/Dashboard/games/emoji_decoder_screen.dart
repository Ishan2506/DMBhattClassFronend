        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Instructions
              _buildInstructionRow(theme, "1", "A sequence of emojis will represent a common phrase or word."),
              const SizedBox(height: 12),
              _buildInstructionRow(theme, "2", "Type your best guess in the text box below the emojis."),
              const SizedBox(height: 12),
              _buildInstructionRow(theme, "3", "Use hints (💡) if you get stuck on a difficult level."),
              const SizedBox(height: 12),
              _buildInstructionRow(theme, "4", "Score 20 points for every correct decoding!"),
              const SizedBox(height: 24),
              // Example Box
              Container(
