...
class _SortingSweepScreenState extends State<SortingSweepScreen> {
  ...
  void _startRound() {
    setState(() {
      _gameOver = false;
      _timeLeft =
          45; // Fixed 45 second round. Goal is to do as many boards as possible
      _generateBoard();
    });
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              "Tap the floating values in strictly ascending order (lowest to highest). Clear as many boards as possible!",
