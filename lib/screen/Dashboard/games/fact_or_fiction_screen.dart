        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Instructions
              _buildInstructionRow(theme, "1", "Read the statement shown on the card."),
              const SizedBox(height: 12),
              _buildInstructionRow(theme, "2", "Decide if it's a 'FACT' (True) or 'FICTION' (False)."),
              const SizedBox(height: 12),
              _buildInstructionRow(theme, "3", "You have 10 seconds for each question."),
              const SizedBox(height: 12),
              _buildInstructionRow(theme, "4", "Accumulate points for correct answers!"),
              const SizedBox(height: 24),
              // Example Box
              Container(
            ...
            children: [
               Column(
                 ...
                 children: [
                   ...
                   TextButton.icon(
                     onPressed: () => _handleAnswer(null), // null means skipped/time up
