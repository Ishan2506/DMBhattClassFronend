...
class TrueFalseResultScreen extends StatefulWidget {
  ...
  @override
  State<TrueFalseResultScreen> createState() => _TrueFalseResultScreenState();
}

class _TrueFalseResultScreenState extends State<TrueFalseResultScreen> {
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Column(
                    ...
                    children: [
                      pw.Text("True/False Exam Result", style: pw.TextStyle(font: fontBold, fontSize: 24)),
            ...
            pw.Container(
              ...
              child: pw.Row(
                ...
                children: [
                   ...
                   _buildPdfStat("Accuracy", "${widget.averageAccuracy.toStringAsFixed(1)}%", fontBold, color: PdfColors.blue),
                ],
              ),
            ),
            pw.SizedBox(height: 20),
              ...
              return pw.Container(
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    pw.SizedBox(height: 4),
                    pw.Text("Correct Answer: $targetText", style: pw.TextStyle(font: font, fontSize: 10, color: PdfColors.green)),
                    pw.Text("Your Answer: $selectedText", style: pw.TextStyle(font: font, fontSize: 10, color: isCorrect ? PdfColors.green : PdfColors.red)),
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _ReviewRow(label: "Correct Answer:", value: targetText, color: Colors.green),
                      _ReviewRow(label: "Your Answer:", value: selectedText, color: isCorrect ? Colors.green : Colors.red),
                    ],
                  ),
                );
              },
