...
class MatchFollowingHistoryScreen extends StatefulWidget {
  const MatchFollowingHistoryScreen({super.key});
...
class _MatchFollowingHistoryScreenState extends State<MatchFollowingHistoryScreen> {
  ...
  Future<void> _deleteEntry(int index) async {
    try {
      ...
      debugPrint("Error deleting match following history entry: $e");
    }
  }
  ...
  Future<void> _clearAll() async {
    ...
    if (confirmed == true) {
      try {
        final prefs = await SharedPreferences.getInstance();
        await prefs.remove('match_following_history');
        _loadHistory();
      } catch (e) {
        debugPrint("Error clearing match following history: $e");
      }
    }
  }
  ...
  String _getTranslation(BuildContext context, String key) {
    ...
    const translations = {
      'en': {
        ...
        'confirmClearMsg': 'Are you sure you want to permanently clear all matching history?',
        'cancel': 'Cancel',
        'clearAllBtn': 'Clear All',
      },
      'gu': {
        'title': 'જોડકા જોડવાનો ઇતિહાસ',
        'noHistory': 'કોઈ ઇતિહાસ મળ્યો નથી.',
        'score': 'ગુણ',
        'accuracy': 'ચોકસાઈ',
        'clearAll': 'બધું સાફ કરો',
        'confirmClearTitle': 'ઇતિહાસ સાફ કરો',
        'confirmClearMsg': 'શું તમે ખરેખર બધો ઇતિહાસ કાયમ માટે સાફ કરવા માંગો છો?',
        'cancel': 'રદ કરો',
        'clearAllBtn': 'સાફ કરો',
      },
      'hi': {
        'title': 'सही मिलान इतिहास',
      ...
      'mr': {
        'title': 'योग्य जोड्या जुळवण्याचा इतिहास',
